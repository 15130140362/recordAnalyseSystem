...
public class setRecord {
    ...
    static List<Tuple4<String,String,String,String>>my;
    static String find;
    @Autowired
    ...
    public static void init()
    {
        ...
        List<Tuple4<String, String, String, String>> my_want = null;
        JavaSparkContext sc = SCC.getLocalSC("reshow");
        ...
        p2.foreach(new VoidFunction<Tuple2<String, Iterable<Tuple4<String, String, String, String>>>>() {
            ...
            public void call(Tuple2<String, Iterable<Tuple4<String, String, String, String>>> stringIterableTuple2) throws Exception {
                ...
                if (key.equals(find)) {
                   List<Tuple4<String, String, String, String>> value = (List<Tuple4<String, String, String, String>>) stringIterableTuple2._2().iterator();
                    my=value;
                   /* while (value.hasNext()) {
    ...
    public static List<Tuple4<String, String, String, String>> getMy() {
        return my;
    }
